...
import callAll from '@/app/helpers/call-all';
...
export default function EditableText({
  ...
  if (isEditing) {
    return (
      <input
        ...
        className={`h-4 bg-inherit font-semibold leading-none text-[#425466] focus:outline-none ${className}`}
        {...props}
      />
    );
  }
  ...
  return (
    <span
      ...
      className={`h-4 bg-inherit font-semibold leading-none text-[#425466] ${className}`}
    >
      {defaultValue}
    </span>
  );
